...
struct StatsStrings {
    ...
    static let empathyDescription = "The Empathy level of the character. Supports interpersonal skills, and also determines how many Humanity Points a Edgerunner has (10x their base Empathy)."
