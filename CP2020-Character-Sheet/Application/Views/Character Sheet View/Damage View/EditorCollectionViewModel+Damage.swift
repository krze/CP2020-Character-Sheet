...
extension EditorCollectionViewModel {
    ...
    private static func description(for field: DamageField) -> String {
        switch field {
        case .Roll:
